...
url_sub = '/news/stock-market-news/'
...
df.to_excel(f'stock-market{dayNo}.xlsx', sheet_name=dayNo, index=False)
similarity_df.to_excel(f'stock-market_similarity{dayNo}.xlsx', sheet_name=dayNo, index=True)
