...
df.to_excel(f'politics{dayNo}.xlsx', sheet_name=dayNo, index=False)
similarity_df.to_excel(f'politics_similarity{dayNo}.xlsx', sheet_name=dayNo, index=True)
