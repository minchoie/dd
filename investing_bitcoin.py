...
press_element = soup_tmp.find('span', class_="shrink-0 text-xs leading-4")
Press_tmp = press_element.get_text() if press_element else 'None'
...
df.to_excel(f'bitcoin#{dayNo}.xlsx', sheet_name=dayNo, index=False)